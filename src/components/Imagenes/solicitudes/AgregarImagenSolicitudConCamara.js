...
const AgregarImagenSolicitudConCamara = ({ solicitudId, onImagenesAgregadas, cameraActive, setCameraActive }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!solicitudId) {
            showSnackbar('Debe seleccionar una solicitud', 'error');
            return;
        }
        setIsLoading(true);
            ...
            <form onSubmit={handleSubmit}>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Typography variant="body2" color="textSecondary" sx={{ ml: 2 }}>
                        {cameraActive ? "Tome una o más fotos para la solicitud" : "Active la cámara para tomar fotos"}
                    </Typography>
                </Box>
...
export default AgregarImagenSolicitudConCamara;
